...
epicsEnvSet("PIMEGA_MODULE01_IP", "10.255.255.10")
...
dbpf(${PREFIX}cam1:dac_defaults_files,"${PIMEGA_PSS}/ioc/epics/iocs/pimegaIOC/iocBoot/iocPimega/config/pimega135d.ini")
